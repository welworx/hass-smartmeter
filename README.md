...
repository, or manually (see Installation below).
...
- [ ] Submit brand assets (icon/logo) to
      ...
      install. Until this lands, the HACS validation workflow's `brands`
      check stays disabled (`ignore: brands` in
      `.github/workflows/validate.yml`).
- [x] Repository description, topics, and issue tracker — HACS checks
      for these too; already in place.
